...
//    //bool postfork = 0/*nHeight >= params.TMIHeight*/;
//    //
//    //if (postfork == false) {
//    //    // Original TMIcoin PoW.
//    //    return TMIcoinGetNextWorkRequired(pindexLast, pblock, params);
//    //}
//    //else if (nHeight < params.TMIHeight + params.TMIPremineWindow) {
//    //    // PoW limit for premine period.
//    //    unsigned int nProofOfWorkLimit = UintToArith256(params.PowLimit(true)).GetCompact();
//    //    return nProofOfWorkLimit;
//    //}
//    //else if (nHeight < params.TMIHeight + params.TMIPremineWindow + params.nDigishieldAveragingWindow) {
//    //    // Pow limit start for warm-up period.
//    //    return UintToArith256(params.powLimitStart).GetCompact();
//    //}
//    //else if (nHeight < params.TMIZawyLWMAHeight) {
...
//unsigned int TMIcoinGetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params& params)
//{
//    assert(pindexLast != nullptr);
//    return UintToArith256(params.PowLimit(false)).GetCompact();
...
//    //assert(pindexFirst);
//    //
//    //return TMIcoinCalculateNextWorkRequired(pindexLast, pindexFirst->GetBlockTime(), params);
//}

//unsigned int TMIcoinCalculateNextWorkRequired(const CBlockIndex* pindexLast, int64_t nFirstBlockTime, const Consensus::Params& params)
//{
//    return UintToArith256(params.PowLimit(false)).GetCompact();
//    //if (params.fPowNoRetargeting)
//    //    return pindexLast->nBits;
...
//    EhInitialiseState(n, k, state, params.EquihashUseTMISalt(height));
//
...
#define BLOCK_GENERATION_OPTION eBlockGenerationOption::TMI
...
//	}
//	break;
//	case eBlockGenerationOption::TMI:
