...
#ifndef TMICOIN_TEST_SCRIPTNUM10_H
#define TMICOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from TMIcoin Core 0.10.0, for cross-comparison.
 */
public:
