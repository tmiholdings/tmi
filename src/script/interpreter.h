...
#ifndef TMICOIN_SCRIPT_INTERPRETER_H
#define TMICOIN_SCRIPT_INTERPRETER_H
...
{
    FORKID_BCC = 0,
    FORKID_TMI = 79, // Atomic number AU
};

static const int FORKID_IN_USE = FORKID_TMI;
...
enum
{
    ...
    // Allow NON_FORKID in legacy tests and blocks under TMI hard fork height
    //
...
#endif // TMICOIN_SCRIPT_INTERPRETER_H
