...
#ifndef TMICOIN_CONSENSUS_VALIDATION_H
#define TMICOIN_CONSENSUS_VALIDATION_H
...
static inline int64_t GetBlockWeight(const CBlock& block, const Consensus::Params& params)
{
    ...
    //int ser_flag = (block.nHeight < (uint32_t)params.TMIHeight) ? SERIALIZE_BLOCK_LEGACY : 0;
...
#endif // TMICOIN_CONSENSUS_VALIDATION_H
