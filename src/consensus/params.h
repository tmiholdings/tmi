...
#ifndef TMICOIN_CONSENSUS_PARAMS_H
#define TMICOIN_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    int BIP66Height;
    /** Block height at which TMIcoin GPU hard fork becomes active */
    //int TMIHeight;
    /** Block height at which Zawy's LWMA difficulty algorithm becomes active */
    int TMIZawyLWMAHeight;
    /** Block height at which Equihash<144,5> becomes active */
    int TMIEquihashForkHeight;
    /** Limit TMICOIN_MAX_FUTURE_BLOCK_TIME **/
    int64_t TMIMaxFutureBlockTime;
    /** Premining blocks for TMIcoin GPU hard fork **/
    //int TMIPremineWindow;
    //bool TMIPremineEnforceWhitelist;
    /**
...
#endif // TMICOIN_CONSENSUS_PARAMS_H
