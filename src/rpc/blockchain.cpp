...
//double GetDifficultyTMIcoin(const CBlockIndex* blockindex)
//{
...
//    }
//
//    //if (0/*blockindex->nHeight >= Params().GetConsensus().TMIHeight*/)
//    //{
//    //    return GetDifficultyINTERNAL(blockindex);
//    //}
//    //else
//    //{
//    //    return GetDifficultyTMIcoin(blockindex);
//    //}
//    return GetDifficultyTMIcoin(blockindex);
//}
...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails)
{
    ...
    //int ser_flags = (blockindex->nHeight < consensusParams.TMIHeight) ? SERIALIZE_BLOCK_LEGACY : 0;
...
UniValue gettxout(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of " TEXT_tmi "coin addresses\n"
