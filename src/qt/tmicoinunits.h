...
#ifndef TMICOIN_QT_TMICOINUNITS_H
#define TMICOIN_QT_TMICOINUNITS_H
...
/** TMIcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class TMIcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit TMIcoinUnits(QObject *parent);

    /** TMIcoin units.
     *  TMIcoin units (TMIcoin Core unit work the same as Bitoin).
     *  @note Source: https://en.tmicoin.it/wiki/Units . 
...
typedef TMIcoinUnits::Unit TMIcoinUnit;

#endif // TMICOIN_QT_TMICOINUNITS_H
