...
bool UpdateManager::versionCheck(const QString &currentRule, const QString &currentVersion)
{
    ...
    const QDomNodeList updataRuleNodeList = doc.firstChildElement(TEXT_tmi "coin-qt").childNodes();
...
QString UpdateManager::createProcessActiveCheck()
{
    ...
    {
        processActiveCheck_.setKey(QDateTime::currentDateTime().toString("%1 hh:mm:ss:zzz").arg(TEXT_tmi "coin-qt"));
