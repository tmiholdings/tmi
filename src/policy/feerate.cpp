...
const std::string CURRENCY_UNIT = "TMI";
...
{
    //static const double dDustThreshold = 1 / GetTMIFeeRate();
    //static CAmount nDustThreshold = (1 > ((CAmount)dDustThreshold * GetTMIFeeRate())) ? dDustThreshold + 1 : dDustThreshold;
