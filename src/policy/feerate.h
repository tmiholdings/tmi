...
#ifndef TMICOIN_POLICY_FEERATE_H
#define TMICOIN_POLICY_FEERATE_H
...
//{
//private:
//    CAmount nFeeRate = 14;//0.14% => TMI / 10000 * nFeeRate
//public:
//    CFeeRate() : {}
...
public:
    ...
    CAmount GetFeePerK() const { return 1; } //{ return GetFeePerAmount(1 * COIN); }//tmi : 오류 회피용
...
#endif //  TMICOIN_POLICY_FEERATE_H
