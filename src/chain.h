...
#ifndef TMICOIN_CHAIN_H
#define TMICOIN_CHAIN_H
 ...
 */
static const int64_t TMICOIN_MAX_FUTURE_BLOCK_TIME = 2 * 60 * 60;
 ...
 */
static const int64_t TIMESTAMP_WINDOW = TMICOIN_MAX_FUTURE_BLOCK_TIME;
