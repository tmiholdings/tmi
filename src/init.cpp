 ...
 * between tmicoind, and tmicoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread(TEXT_tmi "coin-shutoff");
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), TMICOIN_PID_FILENAME));
#endif
...
{
    //const std::string URL_SOURCE_CODE = "<https://github.com/" TEXT_tmi "/" TEXT_tmi "coin>";
    //const std::string URL_WEBSITE = "<https://" TEXT_tmi "coincore.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread(TEXT_tmi "coin-loadblk");
...
/** Sanity checks
 *  Ensure that TMIcoin is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf(TEXT_TMI "coin version %s\n", FormatFullVersion());
}
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single TMIcoin process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", TMICOIN_CONF_FILENAME)).string());
