...
#ifndef TMICOIN_EQUIHASH_H
#define TMICOIN_EQUIHASH_H
...
public:
    ...
    int InitialiseState(eh_HashState& base_state, bool tmi_salt);
...
#define EhInitialiseState(n, k, base_state, tmi_salt)  \
    if (n == 96 && k == 3) {                           \
        Eh96_3.InitialiseState(base_state, tmi_salt);  \
    } else if (n == 200 && k == 9) {                   \
        Eh200_9.InitialiseState(base_state, tmi_salt); \
    } else if (n == 144 && k == 5) {                   \
        Eh144_5.InitialiseState(base_state, tmi_salt); \
    } else if (n == 96 && k == 5) {                    \
        Eh96_5.InitialiseState(base_state, tmi_salt);  \
    } else if (n == 48 && k == 5) {                    \
        Eh48_5.InitialiseState(base_state, tmi_salt);  \
    } else {                                           \
