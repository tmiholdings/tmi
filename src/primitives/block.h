...
#ifndef TMICOIN_PRIMITIVES_BLOCK_H
#define TMICOIN_PRIMITIVES_BLOCK_H
...
public:
    ...
    std::vector<unsigned char> sig; // 각 노드의 블럭 해시 전자서명  //TMI_SIGN_BYTES*iVerificationLength
    ...
    inline void SerializationOp(Stream& s, Operation ser_action)
    {
        ...
        sig.resize(TMI_SIGN_BYTES*iVerificationLength);
    ...
    {
        //return (nBits == 0);
        return sig.size() != (TMI_SIGN_BYTES*iVerificationLength);
    }
...
#endif // TMICOIN_PRIMITIVES_BLOCK_H
