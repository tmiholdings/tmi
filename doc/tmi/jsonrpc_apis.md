...
arguments sample:
```text
tmicoin-cli getblock 4163a497a9c1d4f26f84bd82a27cb13b5902978ead0add2e2809e370ea2709ce 0
```
...
arguments sample:
```text
tmicoin-cli getblock 4163a497a9c1d4f26f84bd82a27cb13b5902978ead0add2e2809e370ea2709ce 1
```
...
arguments sample:
```text
tmicoin-cli getblock 4163a497a9c1d4f26f84bd82a27cb13b5902978ead0add2e2809e370ea2709ce 2
```
...
argument sample:
```text
tmicoin-cli getrawtransaction 85fbb772ed71c7d4081ed16df46436d7acdc58c0832c765278c19c5684621369 1
```
...
argument sample:
```text
tmicoin-cli getrawtransaction 85fbb772ed71c7d4081ed16df46436d7acdc58c0832c765278c19c5684621369 0
```
...
arguments sample:
```text
tmicoin-cli getaccountaddress tmi-test.com
```
...
arguments sample:
```text
tmicoin-cli getnewaddress tmi-test.com
```
...
arguments sample:
```text
tmicoin-cli getaddressesbyaccount tmi-test.com
```
...
arguments sample:
```text
tmicoin-cli getaccount wE5NLPUFcVLCD7xTmzxHMYYsc47tLD2gcA
```
...
arguments sample:
```text
tmicoin-cli listaccounts
```

result sample:
```json
{
 "tmi-test.tmi.com": 0.00000000,
  "tmi-test1.tmi.com": 100.00000000
}
```
...
arguments sample:
```text
tmicoin-cli getbalance tmi-test.com
```
...
arguments sample:
```text
tmicoin-cli sendfrom tmi-test.com MSKCithw8Vnrcqo8xJ1WedWnc9LDsgqvAY 10
```
...
arguments sample:
```text
tmicoin-cli gettransaction 6735e9f16cab2aafb9b36f75d60963124cd1a63ad516bc75c3ec96e50e90c716
```
...
arguments sample:
```text
tmicoin-cli listsinceblock 4163a497a9c1d4f26f84bd82a27cb13b5902978ead0add2e2809e370ea2709ce
```
