...
class BIP66Test(TMIcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # tmicoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and tmicoind produces more specific reject
            # reasons.
