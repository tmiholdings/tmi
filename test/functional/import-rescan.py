...
import RPC call and sends TMI to it. Then other nodes import the addresses,
and the test makes listtransactions and getbalance calls to confirm that the
importing node either did or did not execute rescans picking up the send
transactions.

In the second part of the test, node 0 sends more TMI to each address, and the
...
class ImportRescanTest(TMIcoinTestFramework):
    def __init__(self):
        super().__init__()
