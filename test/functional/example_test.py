...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the TMIcoinTestFramework
    pass

class ExampleTest(TMIcoinTestFramework):
    # Each functional test is a subclass of the TMIcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        TMIcoinTestFramework class so other tests can use it."""
