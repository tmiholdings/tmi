...
from test_framework.test_framework import TMIcoinTestFramework, TMICOIND_PROC_WAIT_TIMEOUT
...
class RawTransactionsTest(TMIcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid tmicoin address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        self.tmicoind_processes[1].wait(timeout=TMICOIND_PROC_WAIT_TIMEOUT)
