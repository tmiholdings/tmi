...
unlocked to sign the TMIcoin-Qt.app bundle.
...
allowing somebody to distribute a TMIcoin-Qt.app or tmicoin-qt-setup.exe with a valid
...
that the tmicoin-qt.exe file inside the installer had not been tampered with.
